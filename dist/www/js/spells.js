...
/***/ function(module, exports, __webpack_require__) {
	...
	var _spells = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../json/spells.json\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

	var _spells2 = _interopRequireDefault(_spells);

	var _showHideButton = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./components/show-hide-button.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

	var _searchFilter = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./components/search-filter.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

	var _cardSizeButton = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./components/card-size-button.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

	var _filterButton = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./components/filter-button.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

	var _filterButtonGroup = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./components/filter-button-group.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

	var _filterSet = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./components/filter-set.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	var SpellBook = function (_React$Component) {
	  ...
	  function SpellBook(props) {
	    ...
	    var _this2 = _possibleConstructorReturn(this, (SpellBook.__proto__ || Object.getPrototypeOf(SpellBook)).call(this, props));

	    var sortedSpellData = utilities.sortObjectsByProp(_spells2.default, "name");
	  ...
	  _createClass(SpellBook, [{
	    ...
	    key: 'setInclusiveFilters',
	    value: function setInclusiveFilters() {
	      var _this = this;
	      var filteredSpells = [];
	    ...
	    value: function getFilteredSpells(spells, filter) {
	        ...
	        if (filter.type && filter.type === "alphabet" && checkFirstCharMatch(spells[i].name, val)) {
	          ...
	          for (spellProp in spells[i]) {
	            if (spells[i][key] === val || checkPartialMatch(spells[i][key], val)) {
	              filteredSpells.push(spells[i]);
	              break;
	            } else if (_typeof(spells[i][spellProp]) === "object") {
	              /**
	    ...
	    value: function renderSpells() {
	      var i = 0;
	      var spells = React.createElement(
	        'div',
	        { className: 'spell-card-container row' },
	        this.state.spells.map(function (spell) {
	          return React.createElement(
	            'div',
	            { key: spell.name, className: 'spell-card col-xs-12 col-sm-6 col-md-4' },
	            React.createElement(
	              'div',
	              { className: 'spell-card-inner' },
	              React.createElement(
	                'h2',
	                { className: 'spell_name' },
	                spell.name
	              ),
	              React.createElement(
	                'span',
	                { className: 'open-button' },
	                React.createElement(_showHideButton.ShowHideButton, { target: ".row" + ".spell" + i, showText: '+', hideText: '-' })
	              ),
	              React.createElement(
	                'span',
	                { className: 'closed-button' },
	                React.createElement(_showHideButton.ShowHideButton, { target: ".row" + ".spell" + i, showText: '+', hideText: '-', startClosed: 'true' })
	              ),
	              React.createElement(
	                'div',
	                { className: "row spell-card-content " + "spell" + i++ },
	                React.createElement(
	                  'div',
	                  { className: 'col-xs-6' },
	                  React.createElement(
	                    'p',
	                    { className: 'spell-card-property spell_level' },
	                    React.createElement(
	                      'strong',
	                      null,
	                      'Level:'
	                  ...
	                  React.createElement(
	                    'p',
	                    { className: 'spell-card-property spell_casting_time' },
	                    React.createElement(
	                      'strong',
	                      null,
	                      'Casting Time:'
	                  ...
	                  React.createElement(
	                    'p',
	                    { className: 'spell-card-property spell_duration' },
	                    React.createElement(
	                      'strong',
	                      null,
	                      'Duration:'
	                  ...
	                  React.createElement(
	                    'p',
	                    { className: 'spell-card-property spell_range' },
	                    React.createElement(
	                      'strong',
	                      null,
	                      'Range:'
	                  ...
	                  React.createElement(
	                    'p',
	                    { className: 'spell-card-property spell_components' },
	                    React.createElement(
	                      'strong',
	                      null,
	                      'Components:'
	                ...
	                React.createElement(
	                  ...
	                  React.createElement(
	                    'p',
	                    { className: 'spell-card-property spell_concentration' },
	                    React.createElement(
	                      'strong',
	                      null,
	                      'Concentration:'
	                  ...
	                  React.createElement(
	                    'p',
	                    { className: 'spell-card-property spell_ritual' },
	                    React.createElement(
	                      'strong',
	                      null,
	                      'Ritual:'
	                  ...
	                  React.createElement(
	                    'p',
	                    { className: 'spell-card-property spell_page' },
	                    React.createElement(
	                      'strong',
	                      null,
	                      'Page:'
	                  ...
	                  React.createElement(
	                    'p',
	                    { className: 'spell-card-property spell_school' },
	                    React.createElement(
	                      'strong',
	                      null,
	                      'School:'
	                  ...
	                  React.createElement(
	                    'p',
	                    { className: 'spell-card-property spell_class' },
	                    React.createElement(
	                      'strong',
	                      null,
	                      'Class:'
	                    ...
	                    ' ',
	                    utilities.getArrayFromObject(spell, 'class', true)
	                  )
	                ),
	                React.createElement(
	                  'div',
	                  ...
	                  React.createElement('p', { className: 'spell_description', dangerouslySetInnerHTML: { __html: spell.description } })
	                )
	              )
	            )
	          );
	    ...
	    value: function render() {
	      var filterOptions = {
	        ...
	        search: {
	          'choices': [{ label: "Name", name: "search_for_name", value: 1, id: "name", checked: true }, { label: "Description", name: "search_for_description", value: 1, id: "description" }, { label: "School", name: "search_for_school", value: 1, id: "school" }]
	        }
	      };
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              ...
	              React.createElement(_cardSizeButton.CardSizeButton, { onUpdate: this.setExclusiveFilters })
	            ),
	            React.createElement(
	              'p',
	              null,
	              'Filters: ',
	              React.createElement(_showHideButton.ShowHideButton, { target: '.filters-wrapper', showText: '+', hideText: '-' })
	            ),
	            React.createElement(
	              'div',
	              ...
	              React.createElement(
	                ...
	                React.createElement(_searchFilter.SearchFilter, {
	                  onUpdate: this.setInclusiveFilters,
	                  context: this,
	                  searchForChoices: filterOptions.search.choices
	                }),
	                React.createElement(_filterSet.FilterSet, {
	                  id: 'page',
	                  label: 'Source',
	              ...
	              React.createElement(
	                ...
	                React.createElement(_showHideButton.ShowHideButton, { target: '.filter-options', showText: '+', hideText: '-' }),
	                React.createElement(
	                  'div',
	                  { className: 'filter-options' },
	                  React.createElement(_filterButton.FilterButton, {
	                    prop: 'concentration',
	                    val: 'yes',
	                    label: 'Concentration',
	                    onUpdate: this.setExclusiveFilters,
	              ...
	              React.createElement(_filterSet.FilterSet, { id: 'casting_time',
	              ...
	              React.createElement(_filterSet.FilterSet, { id: 'school',
	                cssClass: 'col-xs-12 col-sm-6 col-md-3',
	                label: 'School',
	              ...
	              React.createElement(_filterSet.FilterSet, { id: 'class',
	              ...
	              React.createElement(_filterSet.FilterSet, { id: 'level',
	                cssClass: 'col-xs-12 col-sm-6',
	                label: 'Level',
	              ...
	              React.createElement(_filterSet.FilterSet, { id: 'name',
	                cssClass: 'col-xs-12',
	...
	ReactDOM.render(React.createElement(SpellBook, null), document.querySelector('main'));
