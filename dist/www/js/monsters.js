...
/***/ function(module, exports, __webpack_require__) {
	...
	var _monsters = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../json/monsters.json\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

	var _monsters2 = _interopRequireDefault(_monsters);

	var _submitButton = __webpack_require__(160);

	var _textInput = __webpack_require__(161);

	var _buttonGroup = __webpack_require__(162);

	var _showHideButton = __webpack_require__(163);
	...
	var MonsterBook = function (_React$Component) {
	  _inherits(MonsterBook, _React$Component);

	  /**
	   * constructor for MonsterBook
	   * @param  {object} props [element properties/attributes passed in at initialization]
	   */
	  function MonsterBook(props) {
	    _classCallCheck(this, MonsterBook);

	    var _this2 = _possibleConstructorReturn(this, (MonsterBook.__proto__ || Object.getPrototypeOf(MonsterBook)).call(this, props));

	    var sortedMonsterData = _this2.sortMonstersByProp(_monsters2.default, "name");
	  ...
	  _createClass(MonsterBook, [{
	    key: 'update',
	    value: function update(e) {
	      var _this = this;
	      var sortedMonsterData = _this.sortMonstersByProp(_monsters2.default, "name");
	    ...
	    key: 'getMonsterClasses',
	    value: function getMonsterClasses(monsters, string) {
	      var classes = [];
	    ...
	    key: 'getFilteredMonsters',
	    value: function getFilteredMonsters(monsters, filter) {
	        ...
	        if (filter.type && filter.type === "alphabet" && checkFirstCharMatch(monsters[i].name, val)) {
	          ...
	          for (monsterProp in monsters[i]) {
	            if (monsters[i][key] === val || checkPartialMatch(monsters[i][key], val)) {
	              filteredMonsters.push(monsters[i]);
	              break;
	            } else if (_typeof(monsters[i][monsterProp]) === "object") {
	              /**
	    ...
	    key: 'sortMonstersByProp',
	    value: function sortMonstersByProp(monsters, prop) {
	      var i;
	    ...
	    key: 'updateCardSize',
	    value: function updateCardSize(size) {
	    ...
	    key: 'renderSearchfilter',
	    value: function renderSearchfilter() {
	      var _this = this;
	      ...
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_textInput.TextInput, { type: 'text', label: 'Search', name: 'search_monsters', onChange: filter }),
	        _react2.default.createElement(
	          'label',
	          null,
	          _react2.default.createElement('input', { type: 'checkbox', onClick: setDescriptionSearch }),
	          ' Search Description'
	        )
	      );
	    }
	    ...
	    key: 'renderCardSizeButton',
	    value: function renderCardSizeButton() {
	      var _this = this;
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_submitButton.SubmitButton, { label: 'xs', onUpdate: updateSize }),
	        _react2.default.createElement(_submitButton.SubmitButton, { label: 'sm', onUpdate: updateSize }),
	        _react2.default.createElement(_submitButton.SubmitButton, { label: 'md', onUpdate: updateSize }),
	        _react2.default.createElement(_submitButton.SubmitButton, { label: 'lg', onUpdate: updateSize }),
	        _react2.default.createElement(_submitButton.SubmitButton, { label: 'xl', onUpdate: updateSize })
	      );
	    }
	    ...
	    value: function renderFilterButton(key, val, label, usePartialMatch) {
	      var _this = this;
	      var monsters = [];
	      var label = label || val;
	      ...
	      function filter(e) {
	        ...
	        if (e.target.className.indexOf("active") > -1) {
	          ...
	          _this.setState({
	            monsters: _this.sortMonstersByProp(_monsters2.default, "name"),
	    ...
	    key: 'renderFilterButtonGroup',
	    value: function renderFilterButtonGroup(key, choices, multiSelect, type, usePartialMatch) {
	      var _this = this;
	      var monsters = [];
	      ...
	      return _react2.default.createElement(_buttonGroup.ButtonGroup, { choices: choices, groupLabel: key, onUpdate: filter, multiSelect: multiSelect });
	    }
	    ...
	    value: function renderMonsters() {
	      var monsters = _react2.default.createElement(
	        'div',
	        { className: 'monster-card-container' },
	        this.state.monsters.map(function (monster) {
	          return _react2.default.createElement(
	            'div',
	            { key: monster.name, className: 'monster-card col-xs-12 col-sm-6 col-md-4' },
	            _react2.default.createElement(
	              'div',
	              { className: 'monster-card-inner' },
	              _react2.default.createElement(
	                'h2',
	                { className: 'monster_name' },
	                monster.name
	              ),
	              _react2.default.createElement(
	                'p',
	                { className: 'monster-card-property monster_size' },
	                _react2.default.createElement(
	                  'strong',
	                  null,
	                  'size:'
	              ...
	              _react2.default.createElement(
	                'p',
	                { className: 'monster-card-property monster_type' },
	                _react2.default.createElement(
	                  'strong',
	                  null,
	                  'type:'
	              ...
	              _react2.default.createElement(
	                'p',
	                { className: 'monster-card-property monster_subtype' },
	                _react2.default.createElement(
	                  'strong',
	                  null,
	                  'subtype:'
	              ...
	              _react2.default.createElement(
	                'p',
	                { className: 'monster-card-property monster_alignment' },
	                _react2.default.createElement(
	                  'strong',
	                  null,
	                  'alignment:'
	              ...
	              _react2.default.createElement(
	                'p',
	                { className: 'monster-card-property monster_armor_class' },
	                _react2.default.createElement(
	                  'strong',
	                  null,
	                  'armor_class:'
	              ...
	              _react2.default.createElement(
	                'p',
	                { className: 'monster-card-property monster_hit_points' },
	                _react2.default.createElement(
	                  'strong',
	                  null,
	                  'hit_points:'
	              ...
	              _react2.default.createElement(
	                'p',
	                { className: 'monster-card-property monster_hit_dice' },
	                _react2.default.createElement(
	                  'strong',
	                  null,
	                  'hit_dice:'
	              ...
	              _react2.default.createElement(
	                'p',
	                { className: 'monster-card-property monster_speed' },
	                _react2.default.createElement(
	                  'strong',
	                  null,
	                  'speed:'
	              ...
	              _react2.default.createElement(
	                'p',
	                { className: 'monster-card-property monster_strength' },
	                _react2.default.createElement(
	                  'strong',
	                  null,
	                  'strength:'
	              ...
	              _react2.default.createElement(
	                'p',
	                { className: 'monster-card-property monster_dexterity' },
	                _react2.default.createElement(
	                  'strong',
	                  null,
	                  'dexterity:'
	              ...
	              _react2.default.createElement(
	                'p',
	                { className: 'monster-card-property monster_constitution' },
	                _react2.default.createElement(
	                  'strong',
	                  null,
	                  'constitution:'
	              ...
	              _react2.default.createElement(
	                'p',
	                { className: 'monster-card-property monster_intelligence' },
	                _react2.default.createElement(
	                  'strong',
	                  null,
	                  'intelligence:'
	              ...
	              _react2.default.createElement(
	                'p',
	                { className: 'monster-card-property monster_wisdom' },
	                _react2.default.createElement(
	                  'strong',
	                  null,
	                  'wisdom:'
	              ...
	              _react2.default.createElement(
	                'p',
	                { className: 'monster-card-property monster_charisma' },
	                _react2.default.createElement(
	                  'strong',
	                  null,
	                  'charisma:'
	              ...
	              _react2.default.createElement(
	                'p',
	                { className: 'monster-card-property monster_constitution_save' },
	                _react2.default.createElement(
	                  'strong',
	                  null,
	                  'constitution_save:'
	              ...
	              _react2.default.createElement(
	                'p',
	                { className: 'monster-card-property monster_intelligence_save' },
	                _react2.default.createElement(
	                  'strong',
	                  null,
	                  'intelligence_save:'
	              ...
	              _react2.default.createElement(
	                'p',
	                { className: 'monster-card-property monster_wisdom_save' },
	                _react2.default.createElement(
	                  'strong',
	                  null,
	                  'wisdom_save:'
	              ...
	              _react2.default.createElement(
	                'p',
	                { className: 'monster-card-property monster_history' },
	                _react2.default.createElement(
	                  'strong',
	                  null,
	                  'history:'
	              ...
	              _react2.default.createElement(
	                'p',
	                { className: 'monster-card-property monster_perception' },
	                _react2.default.createElement(
	                  'strong',
	                  null,
	                  'perception:'
	              ...
	              _react2.default.createElement(
	                'p',
	                { className: 'monster-card-property monster_damage_vulnerabilities' },
	                _react2.default.createElement(
	                  'strong',
	                  null,
	              ...
	              _react2.default.createElement(
	                'p',
	                { className: 'monster-card-property monster_damage_resistances' },
	                _react2.default.createElement(
	                  'strong',
	                  null,
	                  'damage_resistances:'
	              ...
	              _react2.default.createElement(
	                'p',
	                { className: 'monster-card-property monster_damage_immunities' },
	                _react2.default.createElement(
	                  'strong',
	                  null,
	                  'damage_immunities:'
	              ...
	              _react2.default.createElement(
	                'p',
	                { className: 'monster-card-property monster_condition_immunities' },
	                _react2.default.createElement(
	                  'strong',
	                  null,
	              ...
	              _react2.default.createElement(
	                'p',
	                { className: 'monster-card-property monster_senses' },
	                _react2.default.createElement(
	                  'strong',
	                  null,
	                  'senses:'
	              ...
	              _react2.default.createElement(
	                'p',
	                { className: 'monster-card-property monster_languages' },
	                _react2.default.createElement(
	                  'strong',
	                  null,
	                  'languages:'
	              ...
	              _react2.default.createElement(
	                'p',
	                { className: 'monster-card-property monster_challenge_rating' },
	                _react2.default.createElement(
	                  'strong',
	                  null,
	                  'challenge_rating:'
	      ...
	      if (this.state.monsters.length === 0) {
	        monsters = _react2.default.createElement(
	          'div',
	          { className: 'monster-card-container' },
	          _react2.default.createElement(
	            'h4',
	            { className: 'no-monsters' },
	            'No monsters matching the selected filters'
	          )
	        );
	      }
	    ...
	    key: 'renderFilters',
	    value: function renderFilters(id, className, label, filterOptions) {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_showHideButton.ShowHideButton, { target: targetFilter, showText: '+', hideText: '-' }),
	        _react2.default.createElement(
	          'div',
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              null,
	              'Filters: ',
	              _react2.default.createElement(_showHideButton.ShowHideButton, { target: '.filters-wrapper', showText: '+', hideText: '-' })
	            ),
	            _react2.default.createElement(
	              'div',
	...
	_reactDom2.default.render(_react2.default.createElement(MonsterBook, null), document.querySelector('main'));
...
/***/ function(module, exports) {
	 ...
	 */
	var getObjectsByProp = exports.getObjectsByProp = function getObjectsByProp(arr, propName, val, usePartialMatch) {
	  var i = 0;
	  var objects = [];
	  var _this = this;
	 ...
	 */
	var getAbilityScoreModifier = exports.getAbilityScoreModifier = function getAbilityScoreModifier(num) {
	 ...
	 * @param  {object} data [JSON object to render]
	 */
	var renderJSON = exports.renderJSON = function renderJSON(data) {
	 ...
	 */
	var sortObjectsByProp = exports.sortObjectsByProp = function sortObjectsByProp(objects, prop) {
	  var i;
	 ...
	 * @return {array || string}  [array of classes, or string of classes joined by commas]
	 */
	var getArrayFromObject = exports.getArrayFromObject = function getArrayFromObject(data, key, returnString) {
	  var items = [];
	...
	var SubmitButton = exports.SubmitButton = function (_React$Component) {
	  ...
	  _createClass(SubmitButton, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        "div",
	        { className: cssClass, "data-key": this.props.value, onClick: this.props.onUpdate },
	        this.props.label
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilities = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../node_modules/simple-react-utilities/utilities.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	var ButtonGroup = exports.ButtonGroup = function (_React$Component) {
	  ...
	  function ButtonGroup(props) {
	    ...
	    _this.onChange = _this2.onChange.bind(_this2);
	  ...
	  _createClass(ButtonGroup, [{
	    ...
	    key: 'renderButton',
	    value: function renderButton(choice) {
	      var choiceString = (typeof choice === 'undefined' ? 'undefined' : _typeof(choice)) === "object" ? choice.val : choice;
	      var label = (typeof choice === 'undefined' ? 'undefined' : _typeof(choice)) === "object" ? choice.label : choice;
	      ...
	      return _react2.default.createElement(_submitButton.SubmitButton, { key: choiceString, cssClass: cssClass, value: choiceString, label: label, onUpdate: onChange });
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        this.props.choices.map(function (choice) {
	          return _this.renderButton(choice);
	        })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.ShowHideButton = undefined;
	...
	var ShowHideButton = exports.ShowHideButton = function (_React$Component) {
	  _inherits(ShowHideButton, _React$Component);

	  function ShowHideButton(props) {
	    _classCallCheck(this, ShowHideButton);

	    var _this = _possibleConstructorReturn(this, (ShowHideButton.__proto__ || Object.getPrototypeOf(ShowHideButton)).call(this, props));

	    var stateClass = "show-hide state-shown";
	    var triggerText = _this.props.hideText;

	    if (_this.props.startClosed === "true") {
	      triggerText = _this.props.showText, stateClass = "show-hide state-hidden";
	    }
	  ...
	  _createClass(ShowHideButton, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        "span",
	        { className: this.state.stateClass, onClick: this.showHide },
	        this.state.triggerText
	      );
	    }
	  }]);
