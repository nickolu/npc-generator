...
/***/ function(module, exports, __webpack_require__) {
	...
	var _npcTraits = __webpack_require__(1);
	...
	var utilities = __webpack_require__(162);
	...
	var Generator = function (_React$Component) {
	  ...
	  function Generator(props) {
	    ...
	    var _this2 = _possibleConstructorReturn(this, (Generator.__proto__ || Object.getPrototypeOf(Generator)).call(this, props));
	  ...
	  _createClass(Generator, [{
	    ...
	    value: function renderInput(traitName, label) {
	      ...
	      return React.createElement(
	        ...
	        React.createElement(_submitButton.SubmitButton, {
	          type: 'text',
	...
	ReactDOM.render(React.createElement(Generator, null), document.querySelector('main'));
			...
			"flaws": {
				"conditionals": {
					"specific phobia": [
						...
						"Fear of bridges",
						"Fear of bugs",
						"Fear of butterflies and often most winged insects",
						...
						"Fear of being buried alive by mistake and waking up in a coffin underground"
					]
				}
			},
			"high_ability": {
	    ...
	    value: function render() {
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          null,
	          this.props.label,
	          React.createElement("input", { type: this.props.type, className: "form-control", name: this.props.name, onChange: this.props.onChange })
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ncUtilities = {
	   ...
	   */
	  getObjectByName: function getObjectByName(arr, name) {
	    var i = 0;
	    for (i in arr) {
	      if ('name' in arr[i]) {
	        if (arr[i].name === name) {
	   ...
	   */
	  getObjectsByProp: function getObjectsByProp(arr, propName, val, usePartialMatch) {
	    var i = 0;
	    var objects = [];
	    var _this = this;
	   ...
	   */
	  countItemInArray: function countItemInArray(arr, item) {
	    var i, l;
	    var count = 0;
	   ...
	   */
	  removeObject: function removeObject(arr, obj) {
	    var i, l;
	    var prop;
	   ...
	   * @return {array}      [new array without the specified object]
	   */
	  removeObjectFromArray: function removeObjectFromArray(arr, obj) {
	    var i, l;
	    var prop;
	    var newArray = [];
	    ...
	    if (Array.isArray(arr)) {
	      ...
	      for (i = 0; i < l; i += 1) {
	        if (arr[i] && arr[i].value && arr[i].key && arr[i].value === obj.value && arr[i].key === obj.key) {
	          console.log(arr[i]);
	        } else {
	   ...
	   */
	  sortObjectsByProp: function sortObjectsByProp(objects, prop) {
	    var i, l;
	    var propsArray = [];
	    var newObjectSort = [];
	   ...
	   */
	  getArrayFromObject: function getArrayFromObject(data, key, returnString) {
	    var prop, items;
	  ...
	  */
	  contains: function contains(obj, val) {
	    if (obj.indexOf) {
	  ...
	  titleCase: function titleCase(str) {
	    ...
	    if (typeof str === "string") {
	      ...
	      str = str.join(' ').replace(/Of/gi, 'of').replace(/The/gi, 'the').replace(/In/gi, 'in').replace(/Is/gi, 'is');
	  ...
	  */
	  getAbilityScoreModifier: function getAbilityScoreModifier(num) {
	  ...
	  */
	  getModifier: function getModifier(score) {
